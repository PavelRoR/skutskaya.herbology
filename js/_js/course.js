...
$(document).ready(function () {
    ...
    $(function () {
        /* Таймер */
        var clock;
        var futureDate = new Date("September 1, 2019 00:00 AM UTC+3");
        ...
        if (diff < 0) {
            ...
            // $('#sale-2').text('2 000р.');
            // $('#sale-3').text('3 000р.');
            // $('#today-1').text('12 900р.');
            // $('#today-2').text('24 900р.');
            // $('#today-3').text('34 900р.');
            // $('#link-1').attr('href', 'https://shop.mastervision.su/?r=ordering/cart/as1&id=3836&clean=true&lg=ru');
            // $('#link-2').attr('href', 'https://shop.mastervision.su/?r=ordering/cart/as1&id=3840&clean=true&lg=ru');
            // $('#link-3').attr('href', 'https://shop.mastervision.su/?r=ordering/cart/as1&id=3844&clean=true&lg=ru');
            // $('.prepayment, .timer, .clock-stop, .cost-sale, .cost-today').remove();
